...
<table border="0" align="center" width="80%">
  ...
  <table class="blackbox" border="1" cellpadding="1" cellspacing="1" align="center" width="95%">
    <tbody><tr class="BoldRED" bgcolor="#FFFFFF" style="height:30px;">
      <th class="newtext" bgcolor="#EDEDED" width="20%" style="height:40px;"><div align="center">Officer Name </div></th>
      <th class="newtext" bgcolor="#EDEDED" width="20%" style="height:40px;"><div align="center">Address</div></th>
	  <th class="newtext" bgcolor="#EDEDED" width="20%" style="height:40px;"><div align="center">Email</div></th>
      <th class="newtext" bgcolor="#EDEDED" width="15%" style="height:40px;"><div align="center">Phone Number</div></th>
      <th class="newtext" bgcolor="#EDEDED" width="25%" style="height:40px;"><div align="center">Feedmill Name </div></th>
	...
	?>
      ...
      <td class="gentxt" style="height:40px;"><div align="center"><?php echo $officer_name; ?></div></td>
      <td class="gentxt" style="height:40px;"><div align="center"><?php echo $address; ?></div></td>
      <td class="gentxt" style="height:40px;"><div align="center"><?php echo $email; ?></div></td>
      <td class="gentxt" style="height:40px;"><div align="center"><?php echo $ph_no; ?></div></td>
      <td class="gentxt" style="height:40px;"><div align="center"><?php echo $office; ?></div></td>
